...
def apply_question_overrides(questions):
    """
    Cleans known placeholder answers and adds controlled multiple-choice options
    for questions that should not use random answer choices.
    """
    for q in questions:
        q_text = q.get("question", "").lower()

        if "chief justice of the united states" in q_text:
            q["answers"] = [
                "John Roberts",
                "John G. Roberts",
        ...
        elif "speaker of the house" in q_text:
            # Keep this controlled because it is a current-officeholder question.
            # Update the first answer in questions.json if the Speaker changes.
            existing = [
                clean_answer(answer)
            ...
            if existing:
                ...
                correct = "Update current Speaker in questions.json"

            q["answers"] = existing or [correct]
            q["choices"] = [
                correct,
                "The Vice President",
                "The Chief Justice",
            ...
            if existing:
                ...
                correct = "Update current President in questions.json"
            ...
            if existing:
                ...
                correct = "Update current Vice President in questions.json"
...
questions = apply_question_overrides(load_questions())
progress = load_progress()
