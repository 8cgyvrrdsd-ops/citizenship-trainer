...
# Personal N-400 interview questions intentionally disabled for privacy.
# Future profile-based loading can be restored later if needed.

N400_INTERVIEW_QUESTIONS = [
    {
        "id": "n400_placeholder_1",
        "topic": "Interview",
        "question": "Personalized N-400 interview questions are currently disabled.",
        "answers": ["okay"],
    }
]
...
N400_VOCAB_QUESTIONS = [
    ...
    {"word": "marital status", "meaning": "whether you are married, divorced, single, or widowed", "question": "What is your marital status?", "answers": ["Married", "Single", "Divorced", "Widowed"]},
    {"word": "spouse", "meaning": "husband or wife", "question": "What is your spouse's name?", "answers": ["Sample spouse answer"]},
    {"word": "current home address", "meaning": "where you live now", "question": "What is your current home address?", "answers": ["Sample address"]},
    {"word": "date of birth", "meaning": "when you were born", "question": "What is your date of birth?", "answers": ["Sample birth date"]},
    {"word": "prior", "meaning": "before", "question": "Where did you live prior to your current address?", "answers": ["Sample prior address"]},
